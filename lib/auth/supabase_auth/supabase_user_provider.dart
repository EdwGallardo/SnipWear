...
class SnipWearSupabaseUser extends BaseAuthUser {
  SnipWearSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> snipWearSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = SnipWearSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
