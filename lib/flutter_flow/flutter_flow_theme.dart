...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFA7203C);
  late Color secondary = const Color(0xFF660210);
  late Color tertiary = const Color(0xFFC28A1C);
  ...
  late Color transparentColor = const Color(0x00000000);
  late Color alwaysWhite = const Color(0xFFFFFFFF);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF5578);
  late Color secondary = const Color(0xFFC16F7B);
  late Color tertiary = const Color(0xFFFFC558);
